...
%Due to the spherical shape of the photo cathode, at any orientation of PMT relative to external
...
% Unclear sentence of "Most likely R2083 PMTs will be used in the assembly H2431, in which R2083 is enclosed in the $\mu$-metal shielding."
...
%because, firstly, in our case the  interfering  fringe  field
...
In higher fields, materials with high saturation should be used
...
It is easy to shape and  has moderately high saturation of $1.56/1.96T$
...
In  moderate fields, a higher permeability material, namely Hiperm-49, may be used as intermediate layer after the external layer of shielding.
...
The magnetization curves for Netic and Co-Netic are given in Fig.~\ref{muneco}.
...
\begin{figure}[htbp]
\centering
\subfloat[Magnetization of Netic and Co-Netic.]
{\includegraphics[width=6.5cm,clip=true,bb= 0 0 500 700]{./Netic-conetic.ps.gz}
\label{muneco}}
\qquad
\subfloat[Magnetization curve for Hiperm-49.]
...
(a)- Magnetization curve $B(H)$ for Netic and Co-Netic. B in logarithmic scale ranges from  $10~G$ to $10^5~G$.
Lines at $45^0$ are indicated with the  corresponding permeability. 
(b)-  Magnetization curve $B(H)$ for Hiperm-49 from the Carpenter Company. Vertical scale - $B$ in Gauss, 
...
%After it reduces the external field  to $10-20G$, the rest of work may  
%be easily done  by a high permeability
%cylinder, such as E989-05, which is the standard R2083 shielding in the H2431 assembly. 
...
\label{ednmics}
%The most powerful Final Element Analysis
...
%Reword this sentence: An external field of required magnitude has been created by a thin solenoid with the sizes larger of the model.
...
%The magnetization curve for this material is shown in Fig.\ref{muneco}.}
%\label{barrel}
%\end{figure}
%\clearpage
%\newpage
...
%That  means a very low power dissipation.  
...
%\end{center}
%\caption{ Magnetization curve of the shield Netic-Hyperm-Conetic}
%\label{}}
%\end{figure}
%\clearpage
%\newpage
...
%\includegraphics[width=16cm,clip=true,bb=  100 100 500 500]{}
%\end{center}
%\caption{ Magnetization curve of the shield Steel-Hyperm-Conetic}
%\label{}}
%\end{figure}
%\clearpage
%\newpage
...
%\includegraphics[width=16cm,clip=true,bb=  100 100 500 500]{}
%\end{center}
%\caption{Magnetization curve of the shield Steel-conetic-conetic }
...
\includegraphics[width=16cm,clip=true,bb=  100 100 500 500]{}
\end{center}
\caption{Magnetization curve of the  Steel shield.}
\label{FEAR2083saclay3}}
\end{figure}
%\clearpage
%\newpage
...
\includegraphics[width=16cm,clip=true,bb=  100 100 500 500]{}
\end{center}
\caption{Magnetization curve of the  Netic shield.}
\label{FEAR2083saclay3}}
\end{figure}
%\clearpage
%\newpage
...
Carpenter Silicon Core Iron B-FM, the magnetization curve of which is lower of that for Netic at $H\ge5-7 Oe$.
...
This was done to reduce the weight and cost of the materials. The new design with the correction coil
 between the Co-Netic and Hiperm49 layer is shown 
