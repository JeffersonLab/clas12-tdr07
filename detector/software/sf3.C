...
etc..  A schematic overview of the ClaRa framework is shown in
Fig.~\ref{fig:clara1}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[htbp]
\centering
\includegraphics[width=5in]{clara1.eps} 
\caption{\small{ClaRa network distributed service platform. SCC: Service 
Communication Channel. cMsg: Publish-Subscribe messaging protocol. 
...
physics data processing services are designed, deployed, and managed. ClaRa 
services communicate with each other through message passing.  The
...
\begin{figure}
\begin{center}
\includegraphics[height=3.5in]{gemcgui1.ps}\hspace{0.2in}\includegraphics[height=3.5in]{gemcevent2.eps}
...
Documentation can be found the CLAS12 Software wiki \cite{gemcdoc}.

Some preliminary results for the EC simulated with gemc ares own in Figure \ref{gemcECresults}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\begin{center}
\includegraphics[height=3.5in]{sf2.eps}\hspace{0.2in}\includegraphics[height=3.5in]{gemcevent2.eps}
\caption{EC results from gemc.}\label{gemcECresults}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
results to the event display service. The program is currently developed in 
c, but will eventually be coded in c++, with an object oriented structure. 
